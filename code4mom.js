...
console.info('Code4mom.js has been linked to your file successfully ')
  ...
  this.flow = {
    ...
    webCam: ()=> {
      if (navigator.mediaDevices.getUserMedia) {
        ...
        }).catch(err => console.error('Could not connect with webcam'))
      } else {
       console.error(' webcam not supported in your device')
      }
    },
